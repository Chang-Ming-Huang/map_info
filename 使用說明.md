...
├── .gitignore                          # Git 忽略檔案
└── 輸出檔案/
    ├── 築宜系統傢俱_桃園店_評論_*.json  # 評論數據
    └── images/築宜系統傢俱_桃園店_*/     # 下載的圖片
```
...
[
  {
    ...
    "scraped_at": "爬取時間",
    "review_id": 1,
    "images": ["review_001_img_01.jpg", "review_001_img_02.jpg"],
    "total_images": 2,
    "images_downloaded": true,
    "image_directory": "images/築宜系統傢俱_桃園店_20250913"
  }
]
```
...
- **儲存位置**: `images/築宜系統傢俱_桃園店_YYYYMMDD/`
- **圖片品質**: 高解析度原始圖片
